...
function NotFoundComponent() {
  return (
    <div className="aurora flex min-h-screen items-center justify-center bg-background px-4">
      <div className="glass max-w-md rounded-3xl px-8 py-12 text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="gradient-brand inline-flex items-center justify-center rounded-xl px-5 py-2.5 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Geethanjali" },
